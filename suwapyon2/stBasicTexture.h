...
struct stBasicTexture
{
	...
	bool Create(ID3D11Device* dev, bool rtv, bool srv, bool dsv, bool shared)
	{
		...
		if((textureDesc.MiscFlags & D3D11_RESOURCE_MISC_SHARED_KEYEDMUTEX) == D3D11_RESOURCE_MISC_SHARED_KEYEDMUTEX)
			pTexture->QueryInterface(__uuidof(IDXGIKeyedMutex), (LPVOID*)&mutex);
